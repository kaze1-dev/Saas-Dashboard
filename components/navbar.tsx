...
const Navbar = () => {
  return (
    <div className='ml-3'>
      <nav className='bg-neutral-950 w-46 justify-between px-5 fixed top-3 bottom-3 flex flex-col py-5 font-sans cursor-default rounded-2xl border border-neutral-800 hover:border-neutral-700 transition-all'>
